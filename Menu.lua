...
function menu.leftMountain.enter(params)
    menu.leftMountain.tweens.enter = tween(
        params.duration,
        menu.leftMountain,
        {xy = 0},
...
function menu.middleMountain.enter(params)
    menu.middleMountain.tweens.enter = tween(
        params.duration,
...
function menu.playButton.fadeIn(params)
    menu.playButton.tweens.fadeIn = tween(
        params.duration,
        menu.playButton,
        {alpha = 255},
...
function menu.rightMountain.enter(params)
    menu.rightMountain.tweens.enter = tween(
        params.duration,
        menu.rightMountain,
        {y = -600},
        tween.easing.bounceOut
...
function menu.title.fadeIn(params)
    menu.title.tweens.fadeIn = tween(
        params.duration,
        menu.title.col,
        {a = 255},
        tween.easing.cubicIn
